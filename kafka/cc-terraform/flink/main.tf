...
resource "confluent_kafka_topic" "orders" {
  ...
  rest_endpoint = data.confluent_kafka_cluster.standard.rest_endpoint
  credentials {
...
resource "confluent_schema" "order" {
  ...
  format       = "AVRO"
  schema       = file("/Users/venky/go/src/github.com/venkyraghav/terraform-provider-confluent/examples/configurations/flink-quickstart/schemas/avro/order.avsc")
  credentials {
...
resource "confluent_flink_statement" "populate-orders-source-table" {
  ...
  statement = file("/Users/venky/go/src/github.com/venkyraghav/terraform-provider-confluent/examples/configurations/flink-quickstart/statements/populate-orders-source-table.sql")
  properties = {
